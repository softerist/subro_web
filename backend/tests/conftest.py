...
from app.db.models.user import User, Base # Keep User model import
...
async def db_session(test_engine) -> AsyncGenerator[AsyncSession, None]: # Removed setup_database dependency
