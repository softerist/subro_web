...
from app.core.security import current_active_superuser, get_user_manager # Corrected import
from app.db.session import get_db_session
from app.db.models.user import User
from app.schemas.user import UserRead, AdminUserUpdate # Use the admin schema for updates
from app.core.security import UserManager # Import UserManager type hint
...
async def delete_user_admin(
    target_user: User = Depends(get_user_or_404),
    user_manager: UserManager = Depends(get_user_manager), # Might be needed if using manager.delete
    session: AsyncSession = Depends(get_db_session),
):
    """
