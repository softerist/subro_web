...
class Settings(BaseSettings):
    ...
    DATABASE_URL: PostgresDsn | None = Field(None, validation_alias="DATABASE_URL")
    POSTGRES_SERVER: str | None = Field(None, validation_alias="POSTGRES_SERVER")
    ...
    POSTGRES_PORT: int | None = Field(5432, validation_alias="POSTGRES_PORT")
    ...
    def ASYNC_DATABASE_URI(self) -> str:
        ...
        raise ValueError(
            "Database configuration is incomplete. Set DATABASE_URL or individual POSTGRES_* variables."
        )
